...
Depending on how the system was set up, `date_of_second_contact` may have dates only for customers who have been contacted at least twice, and be `NA` everywhere else.
