...
* `get_dataset()`
    ...
    - if `num_cols` is greater than the total number of columns in the data frame, the function throws an error with the message `"num_cols (<num_cols>) is too high (full dataset has <n> columns)"`, where `<num_cols>` and `<n>` replaced with the actual values as described above
