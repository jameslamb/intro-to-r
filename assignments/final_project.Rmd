...
- What is one "Data Retrieval and Transformation" package you plan to use? What does that package do?
- What is one "Math and Statistics" package you plan to use? What does that package do?
- What is one "Visualization, Presentation, and Reporting" package you plan to use? What does that package do?
...
If you use multiple scripts (totally acceptable!), please include an additional script called "build.R" which specifies the order to run the scripts in.
...
|&nbsp;&nbsp;2. Uses at least one Data Retrieval and Transformation package          |5                         |
...
|&nbsp;&nbsp;7. Code does not call `install.packages()`, `install_github()`, etc.    |1                         |
|**Code Quality Items**                                                              |                          |
|&nbsp;&nbsp;1. Code commenting                                                      |5                         |
...
<details><summary>"All code runs without error (with no reliance on local data)</summary>

**TEST YOUR CODE IN A CLEAN SESSION**

1. run `rm(list = ls())`
2. in RStudio click `Session --> Restart R`
3. run your code

</details>

<details><summary>"All/most external functions are called with `::`"</summary>

See **"Telling R which package to use"** in the programming supplement ([link](../code/programming-supplement))

If you're unsure which package a function in your code came from, try printing it.

```{r objectSource}
library(jsonlite)

x <- fromJSON('{"country": "ITA"}')

print(fromJSON)
```

The line like `<environment: namespace:jsonlite>` in that example means that `fromJSON()` came from the `{jsonlite}` package.

</details>

<details><summary>"Code commenting"</summary>

There are definitely good and bad ways to comment code.
For some tips, see this code-commenting tutorial I like: https://www.learncpp.com/cpp-tutorial/comments/.
...
small meetings where a data scientist presents brief background on the problem they sought to solve and then
invites criticism of their code.
...
You will be asked a few direct questions about the code to test your understanding.
...
|:--------------------------------------------------------------------------------------|:------------------------:|
|**All-or-Nothing Grade Items**                                                         |                          |
|&nbsp;&nbsp;1. Shows at least one data visualization                                   |5                         |
|&nbsp;&nbsp;2. Describes at least one learning or piece of advice for classmates       |5                         |
...
|&nbsp;&nbsp;3. Explanation of the Code                                                 |30                        |
|&nbsp;&nbsp;&nbsp;&nbsp;*(20-30) clear explanation of how the code solves the problem* |                          |
|&nbsp;&nbsp;&nbsp;&nbsp;*(10-19) literal description of the code as-is*                |                          |
|&nbsp;&nbsp;&nbsp;&nbsp;*(0-9) inaccurate or confusing explanation*                    |                          |
|&nbsp;&nbsp;4. Understanding of the Code                                               |20                        |
|&nbsp;&nbsp;&nbsp;&nbsp;*(15-20) demonstrates strong understanding of the codem*       |                          |
|&nbsp;&nbsp;&nbsp;&nbsp;*(6-14) shallow or somewhat incorrect understanding*           |                          |
|&nbsp;&nbsp;&nbsp;&nbsp;*(0-5) significant lack of understandign*                      |                          |
...
* not being prepared to answer questions about the code
  * you'll be asked about design decisions to test your understanding
  * in the past, students have lost points on "explanation of the code" because they copied code from somewhere else (LLMs, Stack Overflow, etc.) and did not understand how it worked
...
Upload a file to the **Final Project (script + report)** dropbox on D2L with a name like `{Firstname}_{Lastname}_report.pdf` (example: `James_Lamb_report.pdf`).
Failure to follow this file-naming format will result in a grade penalty.
...
|&nbsp;&nbsp;&nbsp;&nbsp;*(0-9) very unclear, inaccurate, or confusing explanation or no explanation*    |                      |
